(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["md3-react"] = {}));
    ...
    const ThemeContext = reactExports.createContext(defaultValues);
    function ThemeProvider({ children }) {
        const [mode, setMode] = reactExports.useState("light");
        const [sourceColor, setSourceColor] = reactExports.useState("#4400ee");
        const [scheme, setscheme] = reactExports.useState(b(argbFromHex("#4400ee"), []).schemes["light"]); // Store the generated theme colors here
        const [theme, setTheme] = reactExports.useState(b(argbFromHex("#4400ee"), []));
  ...
  font-weight: ${thisTextTypography.fontWeight};`;
    ...
    function LayoutWithNavigationBar(props) {
        ...
        const [isCompact, setIsCompact] = reactExports.useState(window.matchMedia("(max-width: 600px)").matches);
